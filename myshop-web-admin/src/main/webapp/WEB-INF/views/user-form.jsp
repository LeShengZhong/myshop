                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="username" class="col-sm-2 control-label required">姓名</label>
                            ...
                            <div class="form-group">
                                <label for="phone" class="col-sm-2 control-label mobile ">手机</label>

                                <div class="col-sm-10">
                                    <form:input path="phone" cssClass="form-control required mobile" placeholder="请输入用户的手机"/>
                                </div>
                            </div>
