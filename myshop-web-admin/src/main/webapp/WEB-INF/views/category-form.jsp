                ...
                <div class="col-xs-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">${tbCategory.id == null ? "新增" : "编辑"}分类</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form:form id="inputForm" cssClass="form-horizontal" action="/category/save" method="post" modelAttribute="tbCategory">
                            <form:hidden path="id" />
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input id="parentName" class="form-control" placeholder="请选择" readonly="true" data-toggle="modal" data-target="#modal-default" value="${tbCategory.parent.name}" />
                                    </div>
                                </div>
